...
В системе используются три сервиса:

  -----------------------------------------------------------------------
  Service                             Назначение
  ----------------------------------- -----------------------------------
  db                                  База данных PostgreSQL для хранения
                                      обработанных данных

  loader                              Одноразовый контейнер (ETL).
                                      Загружает CSV данные в БД и
                                      завершает работу

  analytics_app                       Основное аналитическое приложение
                                      (Streamlit), которое подключается к
                                      БД и отображает результаты
  -----------------------------------------------------------------------
